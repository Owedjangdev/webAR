...
import { BarChart3, LayoutDashboard, LogOut, MapPin, QrCode, Store, X } from 'lucide-react'

import { clearSession, getEmail, getRole } from '../../lib/auth.js'
import { displayNameFromEmail } from '../../lib/identity.js'
import Avatar from '../../backoffice/components/Avatar.jsx'

const NAV = [
  { to: '/partner/dashboard', label: 'Tableau de bord', icon: LayoutDashboard },
  { to: '/partner/places', label: 'Mes lieux', icon: MapPin },
  { to: '/partner/qr', label: 'Mes QR codes', icon: QrCode },
  { to: '/partner/stats', label: 'Statistiques', icon: BarChart3 },
]
        ...
        <div className="relative flex items-center justify-between px-5 py-6">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <p className="text-xs text-slate-500">Espace partenaire</p>
            </div>
          </div>
          <button
            type="button"
